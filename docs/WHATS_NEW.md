...
**Patologías:** reclasifica manualmente una patología al grupo correcto (hongos, plagas, deficiencias, etc.) cuando la clasificación automática no acierta.

**Colaboradores y sync:** los predios compartidos descargan de forma fiable condiciones, suelo, lotes, cultivos, inventario, compras (co-propietarios), eventos y tareas — incluso si el primer intento falló por red.
...
## Referencia — v0.2.2 (generación anterior)
